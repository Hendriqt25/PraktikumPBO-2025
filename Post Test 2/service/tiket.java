...
public class tiket {
    ...
    private viewKereta viewKereta = new viewKereta(); 
    private viewKereta viewPenumpang = new viewKereta(); 
    ...
    public void tambahTiket() {
            viewKereta.tampilKereta(daftarKereta);
            System.out.println("\n========   Tambahan Tiket   ==========");
        ...
        if (daftarPenumpang.isEmpty()){
            ...
            viewKereta.tampilPenumpang(daftarPenumpang);
        ...
        public void cariKereta(){
           ...
           System.out.print("Masukkan nomor kereta: "); 
            ...
            scanner.nextLine();
                ...
                System.out.println("Nomor kereta tidak ditemukan! Diperhatikan Brok dengan baik-baik");
                }
            }
